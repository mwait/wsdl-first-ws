 ...
 * 2016-03-23T05:06:30.831+01:00
 * Generated source version: 3.0.2
 * 
 */
@WebServiceClient(name = "CustomerOrdersService", 
                  wsdlLocation = "file:/Users/mc/projekty/wsdl-first-ws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl",
                  targetNamespace = "http://wait.com/") 
public class CustomerOrdersService extends Service {

    public final static URL WSDL_LOCATION;

    public final static QName SERVICE = new QName("http://wait.com/", "CustomerOrdersService");
    public final static QName CustomerOrdersPort = new QName("http://wait.com/", "CustomerOrdersPort");
    static {
        URL url = null;
        try {
            url = new URL("file:/Users/mc/projekty/wsdl-first-ws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerOrdersService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/Users/mc/projekty/wsdl-first-ws/src/main/webapp/WEB-INF/wsdl/CustomerOrders.wsdl");
        }
        WSDL_LOCATION = url;
    }
